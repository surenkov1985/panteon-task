...
$(document).ready(function () {
	...
	if ($(document).scrollTop() < windowHeight && $(document).scrollTop() > windowHeight / 2) {
		$("html, body").animate(
			{
	...
	$(document).on("scroll", function (e) {
		...
		if (documentPosition === 0 && scrollTop > documentPosition) {
			animated = true;
			$("html, body").animate(
				{
					scrollTop: windowHeight,
		...
		if (documentPosition === windowHeight && scrollTop < documentPosition) {
			animated = true;
			$("html, body").animate(
				{
					scrollTop: 0,
